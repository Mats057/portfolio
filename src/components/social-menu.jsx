...
export const SocialMenu = ({animate=true, className=''}) => {

    const [t] = useTranslation();

    return (
      <footer className={`w-full mb-4 xl:mt-4 z-10 flex justify-center items-center select-none ${animate && 'animate-floating '} ${className}`}>
